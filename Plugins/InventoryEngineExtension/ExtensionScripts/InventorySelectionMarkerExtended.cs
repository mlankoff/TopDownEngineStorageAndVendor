...
namespace MoreMountains.InventoryEngine
{
    ...
    /// </summary>
    public class InventorySelectionMarkerExtended : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //one additional 'if' line that check if selected object is not InventorySlot. It prevents from selecting buttons that are inside display canvas
            //probably it will be added to default with next update
            if (_currentSelection.GetComponent<InventorySlot>() == null)
            {
                return;
            }
